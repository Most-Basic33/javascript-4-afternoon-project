...
// Write a constructor function called User. This function should take in 4 parameters called name, age, email, and savedPosts in that order. Name and email will be strings, age will be a number 
//and savedPosts will be an array of objects. 
...
function User(name, age, email, savedPost) {
  this.name = name;
  this.age = age;
  this.email = email;
...
User.prototype.addSavedPost=(id,title,rating)=>{
  (rating>0 && rating<6)?rating=rating:5;
  return this.id + " " + "" title + rating
